...
`* * *` | user | undo and redo | reverse previous actions or reverse the last undo
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`* *` | user |  have a 'send email' feature | send emails to user's contact(s)
`* *` | user |  display pictures | view the display pictures of user's contacts
`*` | user |  access facebook | browse through social media
