...
5. Should be optimized to work in both 32-bit and 64-bit environment.
6. Should be intuitive for general public
7. Should should be able to function without internet.
8. Should be responsive, response within 2 sec
