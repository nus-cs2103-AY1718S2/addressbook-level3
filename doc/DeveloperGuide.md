...
5. Should have at most 1ms response time for every command.
6. Should have command names that concisely describe their function.
7. Should be open-source.
8. Should work on both 32-bit and 64-bit environments.
9. Total project cost should not exceed $5000
10. Should be usable to anyone who has no experience in Command Line Interface
