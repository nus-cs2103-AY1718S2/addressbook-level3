...
4. AddressBook requests confirmation for the change that is to be made
5. User confirms the change to be made
6. AddressBook renames tag for all persons <br>
Use case ends.
...
5a. User denies the change to be made
