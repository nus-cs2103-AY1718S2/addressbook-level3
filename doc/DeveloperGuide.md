...
3. User rename a specific tag in the list
4. AddressBook request for confirmation for the rename
5. User confirms the rename request
...
5a. User cancel the rename request
