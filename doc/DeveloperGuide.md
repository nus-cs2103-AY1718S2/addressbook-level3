...
5. Should be simple enough for non tech savvy users to use.
6. Should be able to save data reliably and accurately.
7. The response to any use action should become visible within 1 second.
