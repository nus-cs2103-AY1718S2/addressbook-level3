...
`* *` | user | undo an action | recover from mistakes like deleting a contact by accident
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user with many persons in the address book | find a person using a certain detail | locate a person easily using names, addresses, emails, etc.
