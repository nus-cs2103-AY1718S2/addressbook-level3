...
`* * *` | user | edit a person's contact detail | update contact details if necessary
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`* *` | user | sort my contacts according to time added | easily access contacts whom I have just met
