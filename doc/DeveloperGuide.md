...
`* *` | user | be able to work offline | check my address book even when I am not connected to the internet
`* *` | user | edit a person's info | update the details of a person when he or she changes their address or contact information
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user | sort people by tags | see people with a certain tag at a glance
