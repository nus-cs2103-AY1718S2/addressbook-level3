...
5. Should not contact anyone directly.
6. Should be operable by a non-technical user without much difficulty.
7. Should handle errors gracefully and give helpful error messages.
