...
3. User requests to rename friends tag to buddies tag
4. AddressBook requests to confirm the change
5. User confirms the change
6. AddressBook renames all the friends tag to buddies tag  <br>
Use case ends.
