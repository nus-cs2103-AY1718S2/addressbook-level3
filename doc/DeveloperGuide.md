...
6. Should have simple commands that user can understand.
7. Should not have any loss of data upon force shutdown.
8. Should work with/without access to the internet.
9. Should respond under 2 seconds after each command.
