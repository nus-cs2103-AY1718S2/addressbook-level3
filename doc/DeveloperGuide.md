...
`* * *` | user | edit a person | edit the phone number and/or email address of an entry
`* * *` | user | find a person by name | locate details of persons without having to go through the entire list
`* * *` | user | tag an entry with keywords | categories entries into groups by associating each of them with a tag
