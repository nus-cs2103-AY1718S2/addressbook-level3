...
`* *` | user | find a person by tags | locate a person easily
`* *` | user | modify a persons details | update the perons with the latest information
`* *` | user | see a list of all persons | easily see my contact list 
