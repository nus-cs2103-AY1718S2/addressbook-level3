...
`* * *` | user | edit a person | change details of the person entered
`* * *` | user | undo and redo | able to undo changes made by edit
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user with many persons in the address book | display tag group | group and display a particular tagged group
