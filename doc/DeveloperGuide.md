...
5. Should work on both 32-bit and 64-bit environment
6. Should be able to store data permanently
7. Should be able to be used by novice who is not familiar with address book
