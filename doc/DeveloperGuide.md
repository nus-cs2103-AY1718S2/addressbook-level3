...
5. Should execute commands within 2 seconds for all available commands.
6. Should be intuitive for people who are not tech-savvy.
7. Should be optimized to work in 32-bit or 64-bit environment.
8. Product should be able to function without internet access.
