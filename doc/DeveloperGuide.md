...
2. AddressBook shows a list of persons with original tag and confirms change with user
3. User confirms the change
4. AddressBook renames the tags of app persons with original tag to the new tag <br>
Use case ends.
