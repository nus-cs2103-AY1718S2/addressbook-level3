...
`* * *` | user | update a person | edit new information or edit wrong information of a person
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`* *` | user | sort my address book | browse through the list quickly for quick check
