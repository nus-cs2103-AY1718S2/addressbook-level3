...
4. AddressBook shows the tag before and after the rename  
5. AddressBook prompt the user to confirm the changes
...
3b. The new tag name already exists
> 3b1. AddressBook shows an error message <br>
  Use case resumes at step 2

5a. User reject the changes
> Use case ends
