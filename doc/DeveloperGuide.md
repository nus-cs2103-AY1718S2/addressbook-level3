...
5. Is compatible with future and older versions of the AddressBook
6. The source code should and remain open source.
7. Should back up data in a separate file to ensure no data loss.
