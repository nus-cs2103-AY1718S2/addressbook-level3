...
`* *` | user who mistypes a person information | edit a person's information | correct some information or update it
`* *` | user with many persons in the address book | add tags on a person | characterise my contacts and grouping them 
