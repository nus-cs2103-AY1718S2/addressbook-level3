...
`* * *` | user | edit a person | edit and update the contact details of a person
`* * *` | user | clear the address book | delete all entries in the address book
`* *` | user | undo and redo my actions | correct my mistakes easily
