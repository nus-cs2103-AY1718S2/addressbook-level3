...
5. Should be intuitive to use for users who are not IT-savvy.
6. Should respond to commands within 2 seconds.
7. Should work on both 32-bit and 64-bit environments.
8. Should be backward compatible with older address book versions.
