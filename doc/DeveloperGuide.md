...
2a. The tag to be renamed does not exist

> 2a1. AddressBook detects that the tag to be renamed does not exist
  2a2. AddressBook shows an error message <br>
  2a3. AddressBook requests for the user to input current name of tag and new name
  2a4. User inputs current name of tag and new name
  Steps 2a1-2a4 are repeated until the tag to be renamed exists
