...
`* * *` | user | undo the last action that I performed | undo a mistake
`* ` | user | have a prompt to confirm before deleting a person | make sure I select the correct person to delete
`* *` | user | filter contacts by tags | quickly view important contacts
