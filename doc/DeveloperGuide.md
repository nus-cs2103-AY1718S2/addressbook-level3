...
`* * *` | user | undo an action | reverse my previous action if I keyed in something wrongly
`* * *` | user | edit a person | update the the contact information of a person if it has been changed
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`* *` | user | display profile pictures | recognise my contacts by their faces
