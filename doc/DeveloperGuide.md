...
1. User requests to show all existing tags
2. AddressBook shows a list of tags
3. User requests to rename a specific tag from above list
4. AddressBook asks user if they want to proceed with the change
5. User confirms
...
3b. The name to rename to already exists
