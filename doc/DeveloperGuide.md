...
`* * *` | user | sort the contacts in alphabetical order | sort the address book after adding new contacts
`* * *` | user with poor memory | take notes quickly | add a reminder which will appear on UI when I open the address book
