...
5. Should be compatible with future and older version of the Addressbook.
6. Should back up data in a separate file to ensure no data loss.
7. Source code should remain open source.
