...
`* * *` | user | list people in address book | see all the people you have added thus far
`* * *` | user | know all details of a person | find out both private and non-private information about that specific person
