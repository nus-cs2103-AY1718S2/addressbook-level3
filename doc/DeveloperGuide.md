...
5. Should respond to user input within 1 second.
6. Should work in both 32-bit and 64-bit environments.
7. Should be usable by a novice who has never used this Address Book system before.
