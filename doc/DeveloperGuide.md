...
`* *` | user | find persons by tags | locate peoples with a similiar affiliation or group easily
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user with other communication platform | copy some informations into the clipboard | paste it somewhere else easily
