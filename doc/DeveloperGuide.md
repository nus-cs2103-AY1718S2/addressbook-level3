...
`* * *` | user | edit a person | correct or change details of person in address book
`* * *` | user | delete a person | remove entries that I no longer need
`* * *` | user | find a person by name | locate details of persons without having to go through the entire list
`* *` | user | tag a person with keywords | easily categorise person into different groups
`* *` | user | find a person by tag | locate details of persons associated with tag without having to go through entire list
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user | find persons by initials of name | locate details easily without entering the full name
`*` | user | find all names matches to keyword | search persons ignoring case-sensitive names
